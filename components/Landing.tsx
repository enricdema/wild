...
import logo from '../public/imgs/wildnode.svg'
...
export const Landing = (props: Props) => {
  ...
  return (
    <div className='flex items-end justify-between mx-2 sm:mx-5 lg:mx-[10%] xl:[15%] 2xl:[18%]'>
      ...
      <Image style={{height:'auto'}} objectFit='contain' src={logo} />
      <p className='w-full px-10 md:px-0 md:max-w-[450px]  text-sm font-medium text-primary/70 leading-7 my-5 md:text-justify text-center'>
      DECONECTA CONECTADO</p>
